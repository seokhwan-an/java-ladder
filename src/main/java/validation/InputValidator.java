...
public class InputValidator {
    ...
    public void validateNullOrBlankInput(String input) {
        if (input.isBlank() || input.isEmpty()) {
            throw new NullOrBlankInputException(NULL_BLANK_ERROR_MESSAGE);
        }
    }

    public void validateLadderHeightInput(String ladderHeight) {
        validateLadderHeightIsNumber(ladderHeight);
        validateLadderHeightIsPositiveNumber(ladderHeight);
    }

    private void validateLadderHeightIsNumber(String ladderHeight) {
        try {
    ...
    private void validateLadderHeightIsPositiveNumber(String ladderHeight) {
